// задача  из группы 224 в телеграмм заполните массив четными целыми числами,
// начиная с числа 2 и выведите их на экран.
...
public class HomeWorck2 {
        ...
        public static void main(String[] args){
            ...
            System.out.println("Содержание массива в строчку: ");
